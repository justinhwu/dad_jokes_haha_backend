...
joke1 = Joke.find_or_create_by(id: 'qrHeiqHJmrc', joke: "What is a vampire's favorite fruit? A blood orange.")
...
joke2 = Joke.find_or_create_by(id: 'WgFY82ozsrc', joke: 'R.I.P. boiled water. You will be mist.')
